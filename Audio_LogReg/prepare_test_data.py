...
def extractAudioFeatures(filePath):
    global COL_NAMES
    ...
    for root, _, files in os.walk(dir):
        ...
        for file in files:
            ...
            if file.endswith(".au"):
                ...
                rowValues = extractAudioFeatures(audio_file_path)
...
def main():
    ...
    if not os.path.exists(test_directory):
        print("{} directory does not exits.".format(test_directory))
        sys.exit()

    print("Test Data directory: ", test_directory)

    # Read and create datafile in CSV format for modeling
    createCSVdata(test_directory)
